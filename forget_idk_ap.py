...
if __name__ == "__main__":
    ...
    # 实际训练过程中，forget loss极度振荡，无法收敛，推测是因为max_length截断了回复部分，导致学习不到 idk 的回复，使得训练无法收敛
    parser.add_argument('--max_length', type=int, default=288, help='max length of the input sequence')
    ...
    parser.add_argument('--forget_data_path', type=str, default='/home/lei/lei_data/yinyucup/train_data/processed/forget.jsonl')
    parser.add_argument('--retain_data_path', type=str, default='/home/lei/lei_data/yinyucup/train_data/processed/retain.jsonl')
    ...
    parser.add_argument('--forget_coeff', type=float, default=0.5)
    ...
    parser.add_argument('--output_dir', type=str, default='${save_root}/${loss_type}_epoch${num_epochs}_${lr}_mask${mask}_${forget_coeff}_${regularization_coeff}')
